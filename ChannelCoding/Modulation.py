...
def plot(x, y, axis_x="", axis_y="", title=""):
    ...
    ax.set(xlabel=axis_x, ylabel=axis_y, title=title)
...
def fsk_demodulation(frequency1, frequency2, sequence):
    ...
    for i in range(0, 10):
        ...
        S2 = 0
        for t in range(0, 100):
            S1 += fsk_product1[t + 100 * (i - 1)]
            fsk_demodulated_signal1[t + 100 * (i - 1)] = S1
            S2 += fsk_product2[t + 100 * (i - 1)]
...
def main(ask=25, psk=25, fsk1=30, fsk2=15):
    ...
    fsk_demodulated_signal1, fsk_demodulated_signal2, sequence_demodulated = fsk_demodulation(fsk1, fsk2,
                                                                                              sequence_fsk_noise)
